...
//4. Додати можливість відображення за вибором параметра Task Notes (Observer pattern).

//  має бути кнопка, яка міняє тип селектора з "by all" (там інфа name+notes), на "by notes"
//  (тільки інфа notes)
